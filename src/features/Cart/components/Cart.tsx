import { IGioiHang, INguoiDung } from 'models';
...
export default function Cart() {
  ...
  const [modalText, setModalText] = React.useState('Do you want buy product');
  const showModal = () => {
    setVisible(true);
  };
  ...
  const mapCart = userReducer?.gioHang.map((v, index) => {
    return (
              ...
              <div className="flex flex-col space-y-4 md:space-y-0 md:space-x-6 md:flex-row">
                ...
                <div className="flex flex-col">
                  ...
                  <p className="dark:text-coolGray-400">
                    ...
                    ligula, semper sed nisl in, cursus commodo elit. Pellentesque sit amet mi luctus
                    ligula euismod lobortis ultricies et nibh.
                  </p>
                </div>
              </div>
